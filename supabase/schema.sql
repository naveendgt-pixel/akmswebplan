...
CREATE TABLE quotations (
  ...
  mini_books_comp BOOLEAN DEFAULT false,
  calendars INTEGER DEFAULT 0,
  calendars_comp BOOLEAN DEFAULT false,
  frames INTEGER DEFAULT 0,
  frames_comp BOOLEAN DEFAULT false,
  cinematic_teaser INTEGER DEFAULT 0,
  cinematic_teaser_comp BOOLEAN DEFAULT false,
  traditional_highlight_video INTEGER DEFAULT 0,
  traditional_highlight_video_comp BOOLEAN DEFAULT false,
  cinematic_candid_video INTEGER DEFAULT 0,
  cinematic_candid_video_comp BOOLEAN DEFAULT false,
  save_the_date INTEGER DEFAULT 0,
  save_the_date_comp BOOLEAN DEFAULT false,
  e_invitation INTEGER DEFAULT 0,
  e_invitation_comp BOOLEAN DEFAULT false,
  other_deliverable VARCHAR(255),
  other_deliverable_qty INTEGER DEFAULT 0,
  other_deliverable_comp BOOLEAN DEFAULT false,
  -- Pricing
