...
export default function AppShell({
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <header className="sticky top-0 z-50 border-b border-[var(--border)] bg-[var(--card)]/80 backdrop-blur-xl backdrop-saturate-150">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[var(--primary)] to-[var(--accent)] text-white font-bold text-base sm:text-lg shadow-lg shadow-[var(--primary)]/25">
              AK
            </div>
      ...
      {/* Mobile Sidebar */}
      <aside 
        className={`fixed left-0 top-0 z-50 h-full w-64 transform bg-[var(--card)] shadow-xl transition-transform duration-300 ease-in-out lg:hidden ${
        ...
        <div className="flex h-full flex-col">
          <div className="flex items-center justify-between border-b border-[var(--border)] px-4 py-4">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[var(--primary)] to-[var(--accent)] text-white font-bold text-lg shadow-lg">
                AK
              </div>
              <div>
      ...
      <div className="mx-auto flex w-full max-w-7xl gap-6 px-4 py-4 sm:px-6 sm:py-6">
        {/* Desktop Sidebar */}
        <aside className="sticky top-[73px] hidden h-[calc(100vh-97px)] w-56 shrink-0 lg:block">
