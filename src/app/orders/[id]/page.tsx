...
<body>
  <div class="header">
    <div class="brand">
      <img src="${origin}/ak-logo-final-v2.png" alt="Aura Knot" />
  ...
  <div class="section">
    ...
    <div class="info-grid">
      <div class="info-box"><div class="label">Customer Name</div><div class="value">${escapeHtml(customer?.name || order.customer_name || "N/A")}</div></div>
