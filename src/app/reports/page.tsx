...
export default function ReportsPage() {
  ...
  const fetchReportData = useCallback(async () => {
    ...
    try {
      ...
      const quotationsResp = await quotationQuery.order("event_date", { ascending: false });
      const quotationsData = (quotationsResp.data ?? []) as QuotationSummary[];
      ...
      const periodQuotations = quotationsData.filter((q) => {
